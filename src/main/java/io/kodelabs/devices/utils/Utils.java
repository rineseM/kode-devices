...
public class Utils {
    ...
    public static ElectronicDevice mapCreateDto(ElectronicDevice electronicDevice,CreateModel createModel){
    ...
    public static ElectronicDevice mapUpdateDto(ElectronicDevice electronicDevice, UpdateModel updateModel){
